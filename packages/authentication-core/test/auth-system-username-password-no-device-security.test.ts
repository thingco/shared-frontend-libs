...
const model = createModel(machine).withEvents({
	...
	ATTEMPT_TO_CHANGE_TEMPORARY_PASSWORD_SUCCEEDED: doSend({ type: "PASSWORD_FORCE_CHANGE_SUCCESS", user: USER_OBJECT }),
	ATTEMPT_TO_CHANGE_TEMPORARY_PASSWORD_FAILED: doSend({ type: "PASSWORD_FORCE_CHANGE_FAILURE", error: "PASSWORD_CHANGE_FAILURE" }),
	ATTEMPT_TO_CHANGE_TEMPORARY_PASSWORD_SUCCEEDED_ON_SECOND_ATTEMPT: doSend({ type: "PASSWORD_FORCE_CHANGE_SUCCESS", user: USER_OBJECT }),
