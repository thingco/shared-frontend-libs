			...
			return (
				<Svg viewBox="0 0 64 64">
					<G fill="none" stroke={stroke} strokeLinecap="round" strokeLinejoin="round">
						<Path
							strokeWidth={strokeWidth}
							d="M52 45.46c0 4.17-2.37 7.54-6.54 7.54A34.46 34.46 0 0111 18.54c0-4.17 3.37-6.54 7.54-6.54a5.26 5.26 0 011.05.09 26.68 26.68 0 014.33 1.18l1 9.34S20.63 25 20.62 25A26.66 26.66 0 0039 43.38l2.38-4.26 9.35 1c1.16 1.14.95 2.64 1.17 4.33a5.26 5.26 0 01.1 1.01z"
						/>
						<Path
							strokeWidth={strokeWidth / 2}
							d="M33 9a22 22 0 0122 22M33 17a14 14 0 0114 14m-14-6a6 6 0 016 6"
						/>
					</G>
				</Svg>
			);
...
export const LineIcon = ({
	...
	<View style={{ height: size, width: size, ...style }} testID="LineIcon">
