...
const App = () => {
	...
	const [verticalScrubber, setVerticalScrubber] = React.useState(
		speedgraphDataInverted.pointSpeeds.length - 1
	);
	...
	return (
		<main>
				...
				>
					<Graph.Canvas padding={{ top: 10, right: 10, bottom: 10, left: 20 }}>
						...
						<Graph.ScrubberHorizontal
							currentDataPointIndex={horizontalScrubber}
							setCurrentDataPointIndex={setHorizontalScrubber}
							startPosition="left"
						/>
					</Graph.Canvas>
				</Graph>
			...
			<section style={{ gridRow: "3 / 5" }}>
				<Graph
					xAxisValues={speedgraphDataInverted.pointSpeeds}
					xAxisMin={0}
					xAxisMax={Math.max(...speedgraphDataInverted.pointSpeeds)}
					xAxisSize={200}
					xAxisStep={10}
					yAxisScale={4}
				>
					<Graph.Canvas padding={{ top: 20, right: 10, bottom: 20, left: 10 }}>
						<Graph.XAxisGridLines />
						...
						<Graph.XAxisAnnotations
							...
							position="bottom"
						/>
						<Graph.HorizontalLineBars />
						<Graph.ScrubberVertical
							currentDataPointIndex={verticalScrubber}
							setCurrentDataPointIndex={setVerticalScrubber}
							startPosition="top"
						/>
					</Graph.Canvas>
				</Graph>
