...
export const stateSelectors: ExposedStateSelectorMap = {
	...
	isForgottenPasswordRequestingReset: (state) => state.matches(AuthStateId.ForgottenPasswordRequestingReset),
	isForgottenPasswordSubmittingReset: (state) => state.matches(AuthStateId.ForgottenPasswordSubmittingReset),
  isForgottenPasswordResetSuccess: (state) =>  state.matches(AuthStateId.ForgottenPasswordResetSuccess),
  ...
  isAuthenticatedValidatingPin: (state) => state.matches(AuthStateId.AuthenticatedValidatingPin),
	...
	isAuthenticatedChangingPassword: (state) => state.matches(AuthStateId.AuthenticatedChangingPassword),
  isAuthenticatedPasswordChangeSuccess: (state) =>  state.matches(AuthStateId.AuthenticatedPasswordChangeSuccess),
  isAuthenticatedPinChangeSuccess: (state) =>  state.matches(AuthStateId.AuthenticatedPinChangeSuccess),
