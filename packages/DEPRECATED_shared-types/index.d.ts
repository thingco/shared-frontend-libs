...
export type BiometricLoginPreference = boolean;
export type BiometricInfoHiddenPreference = boolean;
...
export interface UserPreferences {
	...
	/**
	 * Whether to default to biometric login
	 */
	biometricLoginPref: BiometricLoginPreference;
	/**
	 * Whether to show the biometric info screen on login
	 * This is just a temp fix until it can be added to Auth
	 */
	biometricInfoHidden: BiometricInfoHiddenPreference;
}
