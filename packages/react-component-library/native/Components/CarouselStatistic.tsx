...
export const CarouselStatistic = ({
	...
	let dur = duration({ locale: prefs.localePref });
	...
	return (
		...
		>
			...
			>
				...
				>
					<Text variant={"xxxlarge greyscale50 centred"}>
						{dist(stats.StatTotalDistance)}
					</Text>
					<Text variant={"xxxlarge greyscale50 centred"}>
						{I18n.t("totalDistance")}
					</Text>
				</View>
				<View
					variant={"flexCol centred"}
			...
			>
				<Statistic
					name={I18n.t("completedCount")}
					value={stats.StatCompletedTripCount}
				/>
				<Statistic
					name={I18n.t("perfectCount")}
					value={stats.StatPerfectTripCount}
				/>
				<Statistic
					name={I18n.t("perfectStreak")}
					value={stats.StatPerfectTripStreak}
				/>
				<Statistic
					name={I18n.t("totalEventCount")}
					value={stats.StatTotalEventCount}
				/>
			</View>
		</View>
	);
